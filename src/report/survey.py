"""The questionnaire report: question types, scales, choices, open text."""
...
from src.report.common import _bullet, _find_numeric_outliers, _format_dataset_overview, _numbered
